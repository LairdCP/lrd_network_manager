                                ...
                                GError **       error)
{
    ...
    if (nm_streq0(method, "tls")) {
        ...
        nm_log_info(LOGD_WIFI,
                    "Laird - handling single phase2-authentication-eap method only, %s\n",
                    nm_setting_802_1x_get_phase2_autheap(s_8021x, 0));
        if (nm_setting_802_1x_get_phase2_autheap(s_8021x, 0)) {
            if (noneap_method) {
                g_set_error_literal(error,
                                    NM_CONNECTION_ERROR,
                                    NM_CONNECTION_ERROR_INVALID_PROPERTY,
        ...
        //         todo:  expand - see bug 10820
        nm_log_info(LOGD_WIFI,
                    "Laird - handling single phase2-authentication method only, %s\n",
                    nm_setting_802_1x_get_phase2_auth(s_8021x, 0));
        if (!nm_setting_802_1x_get_phase2_auth(s_8021x, 0)) {
