...
static const struct Opt opt_table[] = {
    ...
    OPT_KEYWORD("proto", NM_MAKE_STRV("WPA", "RSN", "WPA3", )),
    OPT_BYTES("psk", 0),
    OPT_KEYWORD("scan_freq", NULL),
    OPT_INT("scan_ssid", 0, 1),
    OPT_BYTES("ssid", 32),
    OPT_BYTES("subject_match", 0),
    OPT_BYTES("subject_match2", 0),
    OPT_INT("vht", 0, 1),
    OPT_INT("vht_center_freq1", 2412, 5825),
