...
typedef enum {
    ...
    _NM_SETTING_WIRELESS_WAKE_ON_WLAN_DETECT               = 0x200,

    _NM_SETTING_WIRELESS_WAKE_ON_WLAN_ALL = 0x3FE,
...
typedef enum {
    ...
    _NM_WIFI_DEVICE_CAP_CIPHER_CMAC_128 = 0x00080000,
    _NM_WIFI_DEVICE_CAP_CIPHER_CMAC_256 = 0x00100000,
    _NM_WIFI_DEVICE_CAP_CIPHER_GMAC_128 = 0x00200000,
    _NM_WIFI_DEVICE_CAP_CIPHER_GMAC_256 = 0x00400000,
