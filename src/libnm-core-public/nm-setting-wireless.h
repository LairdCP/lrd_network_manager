 ...
 * @NM_SETTING_WIRELESS_WAKE_ON_WLAN_DETECT: Wake on detecting  a network
...
typedef enum {                                                            /*< flags >*/
    ...
    NM_SETTING_WIRELESS_WAKE_ON_WLAN_DETECT               = 0x200,

    NM_SETTING_WIRELESS_WAKE_ON_WLAN_ALL                  = 0x3FE,
