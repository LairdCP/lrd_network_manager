...
static gboolean
has_ap_flags_valid_set(NM80211ApSecurityFlags ap_flags, NM80211ApSecurityFlags mask, NM80211ApSecurityFlags valid)
{
    if (0 == (ap_flags & valid))
...
static gboolean
has_ap_flags_valid_key_mgmt(NM80211ApSecurityFlags ap_flags, NM80211ApSecurityFlags valid)
{
...
static gboolean
has_ap_flags_valid_pair(NM80211ApSecurityFlags ap_flags, NM80211ApSecurityFlags valid)
{
                                            ...
                                            NMDeviceWifiCapabilities   dev_caps)
{
    ...
    if (!strcmp(key_mgmt, "wpa-psk") || !strcmp(key_mgmt, "cckm") || !strcmp(key_mgmt, "wpa-eap")
        ...
        if (!strcmp(key_mgmt, "wpa-psk")) {
            ...
            if (!has_ap_flags_valid_key_mgmt(ap_rsn, NM_802_11_AP_SEC_KEY_MGMT_EAP_SUITE_B_192))
                return FALSE;
        ...
        // validation of pairwise/group ciphers using ap, settings, and dev_caps
        {
            ...
            if (dev_caps) {
                ...
                if (dev_caps & NM_WIFI_DEVICE_CAP_CIPHER_GCMP_128)
...
/**
 * nm_setting_wireless_get_max_scan_interval:
 * @setting: the #NMSettingWireless
 *
