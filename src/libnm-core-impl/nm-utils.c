...
device_supports_ap_ciphers(guint32 dev_caps, guint32 ap_flags, gboolean static_wep)
{
    ...
    if (static_wep) {
        ...
        if (dev_caps & NM_WIFI_DEVICE_CAP_CIPHER_CCMP_256)
            if (ap_flags & NM_802_11_AP_SEC_PAIR_CCMP_256)
                have_pair = TRUE;
        if (dev_caps & NM_WIFI_DEVICE_CAP_CIPHER_GCMP_128)
            if (ap_flags & NM_802_11_AP_SEC_PAIR_GCMP_128)
                have_pair = TRUE;
    ...
    if (!static_wep) {
        ...
        if (dev_caps & NM_WIFI_DEVICE_CAP_CIPHER_CCMP)
            if (ap_flags & NM_802_11_AP_SEC_GROUP_CCMP)
                have_group = TRUE;
        if (dev_caps & NM_WIFI_DEVICE_CAP_CIPHER_CCMP_256)
            if (ap_flags & NM_802_11_AP_SEC_GROUP_CCMP_256)
                have_group = TRUE;
        if (dev_caps & NM_WIFI_DEVICE_CAP_CIPHER_GCMP_128)
            if (ap_flags & NM_802_11_AP_SEC_GROUP_GCMP_128)
                have_group = TRUE;
        if (dev_caps & NM_WIFI_DEVICE_CAP_CIPHER_GCMP_256)
...
static const struct cf_pair a_table[] = {
    ...
    {132, 5660}, {136, 5680}, {140, 5700}, {144, 5720}, {149, 5745}, {152, 5760}, {153, 5765},
...
static const guint a_table_freqs[G_N_ELEMENTS(a_table)] = {
    ...
    5280, 5290, 5300, 5320, 5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640, 5660, 5680, 5700, 5720,
    5745, 5760, 5765, 5785, 5800, 5805, 5825, 4915, 4920, 4925, 4935, 4945, 4960, 4980, 0,
};
