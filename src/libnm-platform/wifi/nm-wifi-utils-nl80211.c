...
#define WLAN_CIPHER_SUITE_GCMP_128  0x000FAC08
#define WLAN_CIPHER_SUITE_GCMP_256  0x000FAC09
#define WLAN_CIPHER_SUITE_CCMP_256  0x000FAC0A
#define WLAN_CIPHER_SUITE_GMAC_128  0x000FAC0B
#define WLAN_CIPHER_SUITE_GMAC_256  0x000FAC0C
#define WLAN_CIPHER_SUITE_CMAC_256  0x000FAC0D
    ...
    if (tb[NL80211_ATTR_CIPHER_SUITES]) {
        ...
        for (i = 0; i < num; i++) {
            ...
            case WLAN_CIPHER_SUITE_CCMP_256:
                info->caps |= _NM_WIFI_DEVICE_CAP_CIPHER_CCMP_256;
                break;
            case WLAN_CIPHER_SUITE_GCMP_128:
                info->caps |= _NM_WIFI_DEVICE_CAP_CIPHER_GCMP_128;
                break;
            case WLAN_CIPHER_SUITE_GCMP_256:
                info->caps |= _NM_WIFI_DEVICE_CAP_CIPHER_GCMP_256;
                break;
            case WLAN_CIPHER_SUITE_AES_CMAC:
                info->caps |= _NM_WIFI_DEVICE_CAP_CIPHER_CMAC_128;
                break;
            case WLAN_CIPHER_SUITE_CMAC_256:
                info->caps |= _NM_WIFI_DEVICE_CAP_CIPHER_CMAC_256;
                break;
            case WLAN_CIPHER_SUITE_GMAC_128:
                info->caps |= _NM_WIFI_DEVICE_CAP_CIPHER_GMAC_128;
                break;
            case WLAN_CIPHER_SUITE_GMAC_256:
                info->caps |= _NM_WIFI_DEVICE_CAP_CIPHER_GMAC_256;
                break;
...
nm_wifi_utils_nl80211_new(int ifindex, struct nl_sock *genl)
{
    ...
    self->can_apscan  = device_info.can_apscan;
