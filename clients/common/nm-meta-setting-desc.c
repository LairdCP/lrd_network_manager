...
static const NMMetaPropertyInfo *const property_infos_802_1X[] = {
	...
	PROPERTY_INFO_WITH_DESC (NM_SETTING_802_1X_PHASE2_AUTH,
		...
		.property_typ_data = DEFINE_PROPERTY_TYP_DATA (
			PROPERTY_TYP_DATA_SUBTYPE (multilist,
				.get_num_fcn_u32 =      MULTILIST_GET_NUM_FCN_U32     (NMSetting8021x, nm_setting_802_1x_get_num_phase2_auths),
				.add_fcn =              MULTILIST_ADD_FCN             (NMSetting8021x, nm_setting_802_1x_add_phase2_auth),
				.remove_by_idx_fcn_u32 = MULTILIST_REMOVE_BY_IDX_FCN_U32 (NMSetting8021x, nm_setting_802_1x_remove_phase2_auth),
				.remove_by_value_fcn =  MULTILIST_REMOVE_BY_VALUE_FCN (NMSetting8021x, nm_setting_802_1x_remove_phase2_auth_by_value),
				.strsplit_plain =       TRUE,
			),
	...
	PROPERTY_INFO_WITH_DESC (NM_SETTING_802_1X_PHASE2_AUTHEAP,
		...
		.property_typ_data = DEFINE_PROPERTY_TYP_DATA (
			PROPERTY_TYP_DATA_SUBTYPE (multilist,
				.get_num_fcn_u32 =      MULTILIST_GET_NUM_FCN_U32     (NMSetting8021x, nm_setting_802_1x_get_num_phase2_autheaps),
				.add_fcn =              MULTILIST_ADD_FCN             (NMSetting8021x, nm_setting_802_1x_add_phase2_autheap),
				.remove_by_idx_fcn_u32 = MULTILIST_REMOVE_BY_IDX_FCN_U32 (NMSetting8021x, nm_setting_802_1x_remove_phase2_autheap),
				.remove_by_value_fcn =  MULTILIST_REMOVE_BY_VALUE_FCN (NMSetting8021x, nm_setting_802_1x_remove_phase2_autheap_by_value),
				.strsplit_plain =       TRUE,
			),
...
static const NMMetaPropertyInfo *const property_infos_WIFI_P2P[] = {
	...
	PROPERTY_INFO_WITH_DESC (NM_SETTING_WIFI_P2P_FREQUENCY,
		.property_type =                &_pt_gobject_int,
	),
	NULL
};
...
static const NMMetaPropertyInfo *const property_infos_WIRELESS[] = {
	...
	PROPERTY_INFO_WITH_DESC (NM_SETTING_WIRELESS_DMS,
		.property_type =                &_pt_gobject_int,
	),
	NULL
};
...
static const NMMetaPropertyInfo *const property_infos_WIRELESS_SECURITY[] = {
	PROPERTY_INFO_WITH_DESC (NM_SETTING_WIRELESS_SECURITY_KEY_MGMT,
		.property_type =                &_pt_gobject_string,
		.property_typ_data = DEFINE_PROPERTY_TYP_DATA (
			.values_static =            NM_MAKE_STRV ("none", "ieee8021x", "wpa-none", "wpa-psk", "wpa-eap", "sae", "cckm",
			                                          "wpa-eap-suite-b", "wpa-eap-suite-b-192", "owe", "owe-only"),
		),
	),
	...
	PROPERTY_INFO_WITH_DESC (NM_SETTING_WIRELESS_SECURITY_PROTO,
		...
		.property_typ_data = DEFINE_PROPERTY_TYP_DATA (
			...
			.values_static =            NM_MAKE_STRV ("wpa", "rsn", "wpa3"),
		),
	),
